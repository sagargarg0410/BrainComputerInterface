        ...
        socket.on('message', (data)=>{
            try {
                //if(JSON.parse(data)['id']==SUB_REQUEST_ID){
                    ...
                    let lAct = JSON.parse(data)['fac'][3]
                    let lPow = JSON.parse(data)['fac'][4]
                    ...
                    if (com == 'neutral')
                    {
                        console.log("Neutral Face Detected")
                       
                        robot.keyTap("down")
                     
                        console.log("Downwards KeyTap Successful")
                        console.log("\n")
                        //sleep(100)
                    }
                    ...
                    else if (com == 'lift')
                    {
                        ...
                        console.log("Upwards KeyTap Successful")
                        console.log("\n")
                        //sleep(100)
                    }
                    console.log("\r\n")
