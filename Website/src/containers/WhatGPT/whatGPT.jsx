  ...
  return (
    <div className='gradient__bg1' id='whatgpt'>
      <div className='features'>
        <Feature title="BRAIN-COMPUTER INTERFACE" text="Welcome to the Future of Interaction: Unleash Your Mind's Potential with Our Brain-Computer Interface Technology. Embark on a journey into the extraordinary world of brain-computer interface (BCI) technology, where the power of your thoughts becomes a catalyst for innovation. 
"/>
      </div>
