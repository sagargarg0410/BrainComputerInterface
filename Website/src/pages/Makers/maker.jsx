        ...
        <div className="container">
            ...
            <div className="card">
                <div className="imgbox">
                    ...
                    <br></br>
                    <h1 className="gradient__text">Joyeeta Choubey</h1>
                </div>
                <div className="content">
                    <p> <br></br>Joyeeta Choubey is currently pursuing
                        her bachelor’s degree in ECE
                        from BVCOE, GGSIPU, New
                        Delhi. She is enthusiastic and motivated learner proficient in front-end technologies.
                        Dedicated to stay up to date with industry trends and emerging technologies .</p>
                </div>
            </div>
            <div className="card">
                <div className="imgbox">
                ...
                <div className="content">
                    <p>Anshu is working as a traniee in Newgen and currently pursuing
                        his bachelor’s degree in ECE
                        from BVCOE, GGSIPU, New
                        Delhi. He is enthusiastic and motivated learner proficient in MERN Stacks.
                        Dedicated to stay up to date with industry trends and emerging technologies.</p>
                </div>
            </div>
            <div className="card">
                ...
                <div className="content">
                    <p>Jatin is currently pursuing
                        ...
                        He has hands-on experience on IOT devices and proficient in data structures and algorithms.
                    </p>
                </div>
            </div>
        </div>
